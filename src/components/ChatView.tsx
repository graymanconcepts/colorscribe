...
const ChatView: React.FC<ChatViewProps> = ({ images, viewMode }) => {
  ...
  // Scroll to bottom when component mounts or when switching to chat view
  useEffect(() => {
  ...
  return (
    <div className="flex-1 flex flex-col relative h-full">
      <div ref={chatContainerRef} className="absolute inset-0 overflow-y-auto pb-[76px]">
        <div className="flex-1 overflow-y-auto flex flex-col-reverse">
          <div className="space-y-6 p-4">
            {[...extendedImages].reverse().map((image) => (
